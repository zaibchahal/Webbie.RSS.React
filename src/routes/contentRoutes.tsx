...
const Rss = {
    ...
    Banks: lazy(() => import('../RssLayout/Banks/selectBank')),
    CreateBanks: lazy(() => import('../RssLayout/Banks/createBank')),
    ManageBanks: lazy(() => import('../RssLayout/Banks/listBank')),
    Devices: lazy(() => import('../RssLayout/RssDashboard')),

    BankAccounts: lazy(() => import('../RssLayout/BankAccounts/listAccounts')),
    CreateAccounts: lazy(() => import('../RssLayout/BankAccounts/createAccount')),

    AccTransaction: lazy(() => import('../RssLayout/Transactions/accTransaction')),

    BillPayments: lazy(() => import('../RssLayout/BillPayments/index')),

    ProfitReport: lazy(() => import('../RssLayout/RssDashboard')),
};

const POS = {
    ProductDefinition: lazy(() => import('../POSLayout/Products/index')),
    ProductCreate: lazy(() => import('../POSLayout/Products/create')),
    BarcodePrint: lazy(() => import('../POSLayout/Products/printBarcode')),
    StockAdjustment: lazy(() => import('../POSLayout/Stock/adjustment')),
    StockCount: lazy(() => import('../POSLayout/Stock/count')),

    Brands: lazy(() => import('../POSLayout/Category/brand')),
    People: lazy(() => import('../POSLayout/Master/people')),
    Categories: lazy(() => import('../POSLayout/Category/category')),

    POS: lazy(() => import('../POSLayout/POS/pos')),
    SaleList: lazy(() => import('../POSLayout/POS/saleList')),
    Purchase: lazy(() => import('../POSLayout/POS/purchase')),
    Return: lazy(() => import('../POSLayout/POS/return')),
};

const rssLayout: RouteProps[] = [
    /**
     * Dashboard
     */
    {
        path: dashboardPagesRss.rssdashboard.path,
    ...
    {
        path: "bank/create/:id?",
        element: <Rss.CreateBanks />,
    },
    {
        path: "manage-Bank",
        element: <Rss.ManageBanks />,
    },
    {
        path: "",
        element: <Rss.Devices />,
    ...
    {
        path: "bankAccount/create/:id?",
        element: <Rss.CreateAccounts />,
    },
    {
        path: "bank-accounts",
        element: <Rss.BankAccounts />,
    },
    /**
     * Transactions
     */

    {
        ...
        element: <Rss.AccTransaction />,
    },
    {
        path: "bill-Payment",
        element: <Rss.BillPayments />,
    },
    /**
     * Reports
     */
    ...
    {
        path: reportsMenu.profit.path,
        element: <Rss.ProfitReport />,
    },



]
const posLayout: RouteProps[] = [

    {
        path: posMenus.products.subMenu.product_definition.path,
        element: <POS.ProductDefinition />,
    },
    {
        path: "product/create/:id?",
        element: <POS.ProductCreate />,
    },
    {
        path: posMenus.products.subMenu.barcodePrint.path,
        element: <POS.BarcodePrint />,
    },
    {
        path: posMenus.products.subMenu.stockAdjust.path,
        element: <POS.StockAdjustment />,
    },
    {
        path: posMenus.products.subMenu.stockCount.path,
        element: <POS.StockCount />,
    },


    {
        path: posMenus.settings.subMenu.brands.path,
        element: <POS.Brands />,
    },
    {
        path: posMenus.settings.subMenu.categories.path,
        element: <POS.Categories />,
    },
    {
        path: posMenus.settings.subMenu.people.path,
        element: <POS.People />,
    },


    {
        path: posMenus.pos.subMenu.pos.path,
        element: <POS.POS />,
    },
    {
        path: "pos/salelist",
        element: <POS.SaleList />,
    },
    {
        path: posMenus.pos.subMenu.purchase.path,
        element: <POS.Purchase />,
    },
    {
        path: posMenus.pos.subMenu.return.path,
        element: <POS.Return />,
    },
...
const LANDING = {
    DASHBOARD: lazy(() => import('../RssLayout/RssDashboard')),
...
const contents = [...presentation, ...documentation, ...rssLayout, ...posLayout];
